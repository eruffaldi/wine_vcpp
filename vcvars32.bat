...
@rem @call "%VS140COMNTOOLS%VCVarsQueryRegistry.bat" 32bit No64bit %1 %2

set VSINSTALLDIR=MISSING
set FrameworkDir32=MISSING
set FrameworkVersion32=MISSING
set Framework40Version=MISSING

set VS140COMNTOOLS=c:\VC\tools\
set VCINSTALLDIR=c:\VC\VC\

@if not "%1"=="8.1" goto win10
rem Win8
set WindowsSdkDir=c:\VC\kit8.1\
set WindowsSDKLibVersion=winv6.3\
goto winall
:win10
set WindowsSdkDir=c:\VC\kit10\
set UCRTVersion=10.0.10240.0
set UniversalCRTSdkDir=c:\VC\kit10\
set LIB=%LIB%;c:\VC\kit8.1\Lib\winv6.3\um\x86
:winall
